...
// constructor to initialize private variable to the database connection
                ...
                // function to insert new record into attendance database
               public function insertAttendees($fname, $lname, $dob, $email, $contact, $specialty){
                ...
                public function getAttendees(){
                        try{
                                $sql = "SELECT * FROM `attendee` a inner join speciallities s on a.specialty_id = s.specialty_id";
                ...
                public function getAttendeesDetails($id){
                        try{
                                $sql = "select * from attendee a inner join speciallities s on a.specialty_id = s.specialty_id where attendee_id = :id";
                                $stmt =$this->db->prepare($sql);
                                $stmt->bindparam(':id',$id);
                                $stmt->execute(); 
                                $result = $stmt->fetch();
